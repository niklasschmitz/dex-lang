...
withSubst :: SubstEnv l o -> UInferM l o a -> UInferM i o a
withSubst = undefined
 ...
 addSrcContext' pos $ case expr of
  ...
  UApp arr f x@(WithSrcH xPos _) -> do
    ...
    (xVal', arr') <- case piTy of
      Abs b rhs -> case lowerNames b rhs of
        Just rhs' -> do
...
inferUDecl :: Bool -> UDecl i l -> UInferM i o (SubstEnv l o)
...
-- inferUTyConDef :: UTyConDef -> UInferM (Name, Nest Binder)
...
checkInstance :: Nest UPatAnnArrow i l -> UType i -> [UMethodDef i] -> UInferM i o (Atom o)
checkInstance = undefined
...
checkMethodDefs :: Name o ->  LabeledItems (Type o) -> [UMethodDef i]
                -> UInferM i o (LabeledItems (Atom o))
...
bindPat :: UPat i l -> Atom o -> UInferM i o (SubstEnv l o)
...
bindPat' :: UPat i l -> Atom o -> CatT (NameSet i) (UInferM i o) (SubstEnv l o)
bindPat' = undefined
